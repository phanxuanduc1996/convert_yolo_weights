...
parser.add_argument('--tflite_model', help='Path to tflite mode file.',
                    default='../../pretrain_models/yolov3.tflite')
parser.add_argument('--input_img', help='Path to input image.',
                    default='0000.0.JPG')
parser.add_argument('--output_img', help='Path to output image.',
                    default='0000.0_output.JPG')
...
def tflite_example(args):
    model_path = os.path.join(
        os.getcwd(), args.tflite_model)
    ...
    interpreter.set_tensor(
        input_details[0]['index'], np.expand_dims(img_resized, 0))
    interpreter.invoke()
